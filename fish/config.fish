   ...
   # TokyoNight Color Palette
    ...
    function fish_prompt
      ...
      if [ "$CMD_DURATION" -gt 30000 ]
        echo $white The last command took (math "$CMD_DURATION/1000") seconds.
      end
    ...
    abbr Si "paru -S" # Install software
    abbr Sr "sudo pacman -R"   # Uninstall some software 
    abbr Su "sudo pacman -Syu"  # Upgrade the system
