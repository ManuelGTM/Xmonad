...
myKeys c =  
  ...
  subKeys "Xmonad Essentials" 
    ...
    ,("M-t",  addName "launch the terminal"   $ spawn "mpv --no-video ~/.config/sounds/M_UI_0000001B.flac" >> spawn myTerminal)  -- launch a terminal
    ...
    ,("M-y",        addName "Mapeo de teclado QWERTY"                     $ spawn "setxkbmap us" >> spawn "mpv --no-video ~/.config/sounds/M_UI_00000039.flac")               --Mapeo teclado QWERTY 
    ,("M-S-y",        addName "Mapeo de teclado Colemak-DH"                     $ spawn "setxkbmap us -variant colemak_dh" >> spawn "mpv --no-video ~/.config/sounds/M_UI_00000039.flac")               --Mapeo teclado QWERTY 
...
myStartupHook = do
        spawnOnce "picom &"
        spawnOnce "amixer -D pulse sset Master 60%"
        spawnOnce "mpv --no-video ~/.config/sounds/M_UI_00000040.flac &"
